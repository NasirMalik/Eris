...
/// Planet is NSManagedObject thus optional here doesn't mean same as optional in swift, as per schema
/// all properties are non-nullable and have default values thus can be safely force unwrapped.
